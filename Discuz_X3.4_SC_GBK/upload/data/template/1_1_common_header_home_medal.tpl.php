...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1568634006, '1', './data/template/1_1_common_header_home_medal.tpl.php', './template/default', 'common/header_home_medal')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1568634006, '1', './data/template/1_1_common_header_home_medal.tpl.php', './template/default', 'common/header_home_medal')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1568634006, '1', './data/template/1_1_common_header_home_medal.tpl.php', './template/default', 'common/header_home_medal')
;?>
